...
public class TextMessage  extends com.pws.integration.pathway.Message  implements java.io.Serializable {
    public TextMessage() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://pathway.integration.pws.com", "textMessage"));
    }
