...
public class LogAWBInvoiceApprovalHelperSessionEJBBean implements LogAWBInvoiceApprovalHelperSessionEJBRemote, LogAWBInvoiceApprovalHelperSessionEJBLocal {
    ...
    /**
     * Applies the invoice reconciliation data to the airway bill. Should be
     * called when the AWB reconciliation has been approved.
     *
     * @param logAirwayBill
     * @return
     */
...
//				method.releaseConnection();
    ...
    /**
     * Created a logistics finance invoice based on the report name that has
     * been reconciled.
     *
     * @param fileName
     * @return
