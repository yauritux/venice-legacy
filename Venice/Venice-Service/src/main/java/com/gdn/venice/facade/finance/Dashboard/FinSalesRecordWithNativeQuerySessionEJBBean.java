 ...
 * 
 */
@Stateless(mappedName = "FinSalesRecordWithNativeQuerySessionEJBBean")
public class FinSalesRecordWithNativeQuerySessionEJBBean implements FinSalesRecordWithNativeQuerySessionEJBRemote{
	 ...
	 * Default constructor.
	 */
	public FinSalesRecordWithNativeQuerySessionEJBBean() {
		super();
