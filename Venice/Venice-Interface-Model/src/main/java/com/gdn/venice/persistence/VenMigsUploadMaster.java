...
/**
 * The persistent class for the ven_migs_upload_master database table.
 * 
 */
@Entity
@Table(name="ven_migs_upload_master")
public class VenMigsUploadMaster implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.TABLE, generator="ven_migs_upload_master")  
	@TableGenerator(name="ven_migs_upload_master", table="openjpaseq", pkColumnName="id", valueColumnName="sequence_value", allocationSize=1)  //flush every 1 insert
