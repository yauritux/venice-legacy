...
public class RejectCSPaymentDataCommand implements RafRpcCommand {

	String paymentId;
	
	public RejectCSPaymentDataCommand(String paymentId) {
	...
	public String execute() {
		...
		venPaymentStatus.setPaymentStatusId(DataConstantNameTokens.VENORDERPAYMENT_PAYMENTSTATUSID_REJECTED);
