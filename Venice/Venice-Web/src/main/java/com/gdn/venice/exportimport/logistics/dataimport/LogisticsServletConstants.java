 ...
 * 
 */
public interface LogisticsServletConstants {
	/**
	...
	public static String EXCEPTION_TEXT_INVOICE_SUBMITTED_APPROVED = "An invoice with this number has already been submitted for approval or approved. A unique invoice number must be provided!";
