 ...
 *
 */
public class FetchPartyTypeDataCommand implements RafDsCommand {
	 ...
	 * @param rafDsRequest
	 */
	public FetchPartyTypeDataCommand(RafDsRequest rafDsRequest) {
	...
	public RafDsResponse execute() {
		...
		try{
			...
			venPartyTypeList = venPartyTypeSessionHome.queryByRange("select o from VenPartyType o where o.partyTypeDesc in ('Bank', 'Merchant', 'Recipient', 'Customer' )", 0, 0);

			
			/*
			 * Map the values from the combo box (Party Type Desc field)
			 */
