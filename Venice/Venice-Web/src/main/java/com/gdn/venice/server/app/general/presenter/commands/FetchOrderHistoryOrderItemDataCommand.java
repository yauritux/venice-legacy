...
public class FetchOrderHistoryOrderItemDataCommand implements RafDsCommand {
	RafDsRequest request;	
	
	public FetchOrderHistoryOrderItemDataCommand(RafDsRequest request) {
	...
	public RafDsResponse execute() {
		...
		try{
			...
			String query = "select o from VenOrderItemStatusHistory o where o.venOrderItem.venOrder.orderId="+ request.getParams().get(DataNameTokens.VENORDER_ORDERID).toString()+ " order by o.id.historyTimestamp desc";		
