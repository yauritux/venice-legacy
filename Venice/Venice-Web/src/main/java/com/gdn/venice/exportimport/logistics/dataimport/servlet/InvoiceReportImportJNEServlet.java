...
/**
 * Servlet implementation class InvoiceReportImportJNEServlet.
 * 
 * <p>
...
public class InvoiceReportImportJNEServlet extends HttpServlet {
	 ...
	 */
	public InvoiceReportImportJNEServlet() {
		super();
		Log4jLoggerFactory loggerFactory = new Log4jLoggerFactory();
		_log = loggerFactory.getLog4JLogger("com.gdn.venice.logistics.dataimport.servlet.InvoiceReportImportJNEServlet");
	}
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		_log.info("InvoiceReportImportJNEServlet:hello");
		...
		if (isMultipart) { // import
			...
			if (invoiceNumber == null || invoiceNumber.isEmpty()) {
				...
				fileName = sdf.format(new Date()) + "-" + invoiceNumber + "-invoiceReportJNE.xls";
			}
