...
/**
 * Servlet implementation class ActivityReportImportMSGServlet.
 *
 * <p> <b>author:</b> <a href="mailto:david@pwsindonesia.com">David Forden</a>
 * <p> <b>version:</b> 1.0 <p> <b>since:</b> 2011
 *
 */
public class ActivityReportImportMSGServlet extends HttpServlet {
    ...
    private SimpleDateFormat sdf = new SimpleDateFormat(LogisticsServletConstants.DATE_TIME_FORMAT_STRING);
    /*
     ...
     */
    public ActivityReportImportMSGServlet() {
        super();
        Log4jLoggerFactory loggerFactory = new Log4jLoggerFactory();
        _log = loggerFactory.getLog4JLogger("com.gdn.venice.logistics.dataimport.servlet.ActivityReportImportMSGServlet");
    }
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        _log.info("ActivityReportImportMSGServlet");

        notificationText = LogisticsConstants.JAVASCRIPT_ALERT_NOTIFICATION_TEXT_DEFAULT;

        if (isMultipart) { // import

            String fileName = sdf.format(new Date()) + "-activityReportMSG.xls";
            ...
            fileUploadLog.setFileUploadFormat("MSG");
