...
/**
 * Servlet implementation class ActivityReportImportJNEServlet.
 * 
 *@author Roland
 * 
 */
@SuppressWarnings("unused")
public class ActivityReportImportJNEServlet extends HttpServlet {
	 ...
	 */
	public ActivityReportImportJNEServlet() {
		super();
		Log4jLoggerFactory loggerFactory = new Log4jLoggerFactory();
		_log = loggerFactory.getLog4JLogger("com.gdn.venice.logistics.dataimport.servlet.ActivityReportImportJNEServlet");
	}
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (isMultipart) { // import
			...
			fileUploadLog.setFileUploadFormat("JNE");
