...
/**
 * Servlet implementation class InvoiceReportImportRPXServlet.
 * 
 * <p>
...
public class InvoiceReportImportRPXServlet extends HttpServlet {
	 ...
	 */
	public InvoiceReportImportRPXServlet() {
		super();
		Log4jLoggerFactory loggerFactory = new Log4jLoggerFactory();
		_log = loggerFactory.getLog4JLogger("com.gdn.venice.logistics.dataimport.servlet.InvoiceReportImportRPXServlet");
	}
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		_log.info("InvoiceReportImportRPXServlet:hello");
		...
		if (isMultipart) { // import
			...
			if(invoiceNumber == null || invoiceNumber.isEmpty()){
				...
				fileName = sdf.format(new Date()) + "-" + invoiceNumber + "-invoiceReportRPX.xls";
			}
