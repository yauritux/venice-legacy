...
/**
 * This is the journal list grid that appears in the journal tab of journal processing
 * <p>
 ...
 * 
 */
public class JournalsListGridWidget extends ListGrid {
	
	/**
	 * Basic constructor to setup the list grid
	 */
	public JournalsListGridWidget() {
		setWidth100();
		setHeight100();
