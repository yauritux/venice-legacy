...
public class UpdateOrderStatusDataCommand implements RafRpcCommand {
    ...
    public String execute() {
        ...
        try {
            ...
            List<VenOrder> orders = sessionHome.queryByRange("select o from VenOrder o join fetch o.venOrderItems where o.orderId = " + orderId, 0, 1);
            if (orders.size() > 0) {
                order = orders.get(0);
                ...
                return "Cannot update order with no item";
            }
