...
public class FraudCustomerWhitelistPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<FraudCustomerWhitelistPresenter> implements com.gdn.venice.client.app.fraud.presenter.FraudCustomerWhitelistPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<FraudCustomerWhitelistPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<FraudCustomerWhitelistPresenter>( ginjector.getFraudCustomerWhitelistPresenter() );
      
    }
  }
  
  public FraudCustomerWhitelistPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!fraudCustomerWhiteListMaintenancePage"; 
