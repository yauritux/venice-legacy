...
public class FinanceDashboardPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<FinanceDashboardPresenter> implements com.gdn.venice.client.app.finance.presenter.FinanceDashboardPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<FinanceDashboardPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<FinanceDashboardPresenter>( ginjector.getFinanceDashboardPresenter() );
      
    }
  }
  
  public FinanceDashboardPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!financeDashboardPage"; 
