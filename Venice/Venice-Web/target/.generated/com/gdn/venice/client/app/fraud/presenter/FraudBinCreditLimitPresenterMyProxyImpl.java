...
public class FraudBinCreditLimitPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<FraudBinCreditLimitPresenter> implements com.gdn.venice.client.app.fraud.presenter.FraudBinCreditLimitPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<FraudBinCreditLimitPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<FraudBinCreditLimitPresenter>( ginjector.getFraudBinCreditLimitPresenter() );
      
    }
  }
  
  public FraudBinCreditLimitPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!fraudBinCreditLimitPage"; 
