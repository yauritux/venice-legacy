...
public class FraudParameterRule31PresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<FraudParameterRule31Presenter> implements com.gdn.venice.client.app.fraud.presenter.FraudParameterRule31Presenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<FraudParameterRule31Presenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<FraudParameterRule31Presenter>( ginjector.getFraudParameterRule31Presenter() );
      
    }
  }
  
  public FraudParameterRule31PresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!fraudParameterRule31Page"; 
