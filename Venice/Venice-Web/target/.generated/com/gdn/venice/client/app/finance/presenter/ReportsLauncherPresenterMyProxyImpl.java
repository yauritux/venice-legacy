...
public class ReportsLauncherPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<ReportsLauncherPresenter> implements com.gdn.venice.client.app.finance.presenter.ReportsLauncherPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<ReportsLauncherPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<ReportsLauncherPresenter>( ginjector.getReportsLauncherPresenter() );
      
    }
  }
  
  public ReportsLauncherPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!financeReportsDialogPage"; 
