...
public class BlackListMaintenancePresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<BlackListMaintenancePresenter> implements com.gdn.venice.client.app.fraud.presenter.BlackListMaintenancePresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<BlackListMaintenancePresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<BlackListMaintenancePresenter>( ginjector.getBlackListMaintenancePresenter() );
      
    }
  }
  
  public BlackListMaintenancePresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!fraudBlackListMaintenancePage"; 
