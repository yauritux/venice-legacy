...
public class KpiDetailViewerPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<KpiDetailViewerPresenter> implements com.gdn.venice.client.app.kpi.presenter.KpiDetailViewerPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<KpiDetailViewerPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<KpiDetailViewerPresenter>( ginjector.getKpiDetailViewerPresenter() );
      
    }
  }
  
  public KpiDetailViewerPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!kpiDetailViewerPage"; 
