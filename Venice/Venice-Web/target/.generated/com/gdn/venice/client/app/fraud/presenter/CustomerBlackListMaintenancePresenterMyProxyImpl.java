...
public class CustomerBlackListMaintenancePresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<CustomerBlackListMaintenancePresenter> implements com.gdn.venice.client.app.fraud.presenter.CustomerBlackListMaintenancePresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<CustomerBlackListMaintenancePresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<CustomerBlackListMaintenancePresenter>( ginjector.getCustomerBlackListMaintenancePresenter() );
      
    }
  }
  
  public CustomerBlackListMaintenancePresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!fraudCustomerBlackListMaintenancePage"; 
