...
public class ActivityReportReconciliationPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<ActivityReportReconciliationPresenter> implements com.gdn.venice.client.app.logistic.presenter.ActivityReportReconciliationPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<ActivityReportReconciliationPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<ActivityReportReconciliationPresenter>( ginjector.getLogisticActivityReportReconciliationPresenter() );
      
    }
  }
  
  public ActivityReportReconciliationPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!logisticActivityReportReconciliationPage"; 
