...
public class ModuleConfigurationPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<ModuleConfigurationPresenter> implements com.gdn.venice.client.app.administration.presenter.ModuleConfigurationPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<ModuleConfigurationPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<ModuleConfigurationPresenter>( ginjector.getModuleConfigurationPresenter() );
      
    }
  }
  
  public ModuleConfigurationPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!adminModuleConfiguration"; 
