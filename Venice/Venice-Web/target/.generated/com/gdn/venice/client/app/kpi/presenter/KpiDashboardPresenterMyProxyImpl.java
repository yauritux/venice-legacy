...
public class KpiDashboardPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<KpiDashboardPresenter> implements com.gdn.venice.client.app.kpi.presenter.KpiDashboardPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<KpiDashboardPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<KpiDashboardPresenter>( ginjector.getKpiDashboardPresenter() );
      
    }
  }
  
  public KpiDashboardPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!kpiDashboardPage"; 
