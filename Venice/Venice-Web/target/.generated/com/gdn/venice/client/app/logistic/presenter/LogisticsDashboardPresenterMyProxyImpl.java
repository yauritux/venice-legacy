...
public class LogisticsDashboardPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<LogisticsDashboardPresenter> implements com.gdn.venice.client.app.logistic.presenter.LogisticsDashboardPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<LogisticsDashboardPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<LogisticsDashboardPresenter>( ginjector.getLogisticsDashboardPresenter() );
      
    }
  }
  
  public LogisticsDashboardPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!logisticDashboardPage"; 
