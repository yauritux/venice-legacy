...
public class TestRestDataSourcePresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<TestRestDataSourcePresenter> implements com.gdn.venice.client.app.testrestdatasource.presenter.TestRestDataSourcePresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<TestRestDataSourcePresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<TestRestDataSourcePresenter>( ginjector.getTestRestDataSourcePresenter() );
      
    }
  }
  
  public TestRestDataSourcePresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!testRestDataSourcePage"; 
