...
public class ReturDataViewerPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<ReturDataViewerPresenter> implements com.gdn.venice.client.app.general.presenter.ReturDataViewerPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<ReturDataViewerPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<ReturDataViewerPresenter>( ginjector.getReturDataViewerPresenter() );
      
    }
  }
  
  public ReturDataViewerPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!generalReturDataViewer"; 
