...
public class FundInReconciliationPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<FundInReconciliationPresenter> implements com.gdn.venice.client.app.finance.presenter.FundInReconciliationPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<FundInReconciliationPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<FundInReconciliationPresenter>( ginjector.getFundInReconciliationPresenter() );
      
    }
  }
  
  public FundInReconciliationPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!financeFundInReconciliationPage"; 
