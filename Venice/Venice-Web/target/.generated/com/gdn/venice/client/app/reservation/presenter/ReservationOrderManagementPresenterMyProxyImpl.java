...
public class ReservationOrderManagementPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<ReservationOrderManagementPresenter> implements com.gdn.venice.client.app.reservation.presenter.ReservationOrderManagementPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<ReservationOrderManagementPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<ReservationOrderManagementPresenter>( ginjector.getReservationOrderManagementPresenter() );
      
    }
  }
  
  public ReservationOrderManagementPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!reservationOrderManagement"; 
