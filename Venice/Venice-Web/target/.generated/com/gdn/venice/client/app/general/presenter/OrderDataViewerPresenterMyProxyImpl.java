...
public class OrderDataViewerPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<OrderDataViewerPresenter> implements com.gdn.venice.client.app.general.presenter.OrderDataViewerPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<OrderDataViewerPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<OrderDataViewerPresenter>( ginjector.getOrderDataViewerPresenter() );
      
    }
  }
  
  public OrderDataViewerPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!generalOrderDataViewer"; 
