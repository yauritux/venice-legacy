...
public class PartyMaintenancePresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<PartyMaintenancePresenter> implements com.gdn.venice.client.app.general.presenter.PartyMaintenancePresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<PartyMaintenancePresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<PartyMaintenancePresenter>( ginjector.getPartyMaintenancePresenter() );
      
    }
  }
  
  public PartyMaintenancePresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!generalPartyMaintenance"; 
