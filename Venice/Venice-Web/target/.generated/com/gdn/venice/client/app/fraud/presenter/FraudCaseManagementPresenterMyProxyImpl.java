...
public class FraudCaseManagementPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<FraudCaseManagementPresenter> implements com.gdn.venice.client.app.fraud.presenter.FraudCaseManagementPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<FraudCaseManagementPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<FraudCaseManagementPresenter>( ginjector.getFraudCaseManagementPresenter() );
      
    }
  }
  
  public FraudCaseManagementPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!fraudCaseManagementPage"; 
