...
public class RoleProfileUserGroupManagementPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<RoleProfileUserGroupManagementPresenter> implements com.gdn.venice.client.app.administration.presenter.RoleProfileUserGroupManagementPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<RoleProfileUserGroupManagementPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<RoleProfileUserGroupManagementPresenter>( ginjector.getRoleProfileUserGroupManagementPresenter() );
      
    }
  }
  
  public RoleProfileUserGroupManagementPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!adminRoleProfileUserGroup"; 
