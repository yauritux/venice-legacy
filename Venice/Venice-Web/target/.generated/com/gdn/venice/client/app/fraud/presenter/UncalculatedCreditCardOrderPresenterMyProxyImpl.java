...
public class UncalculatedCreditCardOrderPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<UncalculatedCreditCardOrderPresenter> implements com.gdn.venice.client.app.fraud.presenter.UncalculatedCreditCardOrderPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<UncalculatedCreditCardOrderPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<UncalculatedCreditCardOrderPresenter>( ginjector.getUncalculatedCreditCardOrderPresenter() );
      
    }
  }
  
  public UncalculatedCreditCardOrderPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!fraudUncalculatedCreditCardOrder"; 
