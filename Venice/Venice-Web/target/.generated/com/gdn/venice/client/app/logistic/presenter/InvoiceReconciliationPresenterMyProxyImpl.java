...
public class InvoiceReconciliationPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<InvoiceReconciliationPresenter> implements com.gdn.venice.client.app.logistic.presenter.InvoiceReconciliationPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<InvoiceReconciliationPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<InvoiceReconciliationPresenter>( ginjector.getLogisticInvoiceReconciliationPresenter() );
      
    }
  }
  
  public InvoiceReconciliationPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!logisticInvoiceReconciliationPage"; 
