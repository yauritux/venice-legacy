...
public class DeliveryStatusTrackingPresenterMyProxyImpl extends com.gwtplatform.mvp.client.proxy.ProxyPlaceImpl<DeliveryStatusTrackingPresenter> implements com.gdn.venice.client.app.logistic.presenter.DeliveryStatusTrackingPresenter.MyProxy, com.gwtplatform.mvp.client.DelayedBind {
  
  private com.gdn.venice.client.app.VeniceGinjector ginjector;
  
  public static class WrappedProxy
  extends com.gwtplatform.mvp.client.proxy.ProxyImpl<DeliveryStatusTrackingPresenter> {
    ...
    private void delayedBind( com.gdn.venice.client.app.VeniceGinjector ginjector ) {
      ...
      presenter = new CodeSplitProvider<DeliveryStatusTrackingPresenter>( ginjector.getLogisticDeliveryStatusTrackingPresenter() );
      
    }
  }
  
  public DeliveryStatusTrackingPresenterMyProxyImpl() {
  ...
  public void delayedBind( Ginjector baseGinjector ) {
    ...
    proxy = wrappedProxy; 
    String nameToken = "!logisticDeliveryStatusTrackingPage"; 
