...
public class AsyncLoader44 {
// Callbacks that are pending
private static AsyncLoader44__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader44__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader44 instance = null;
public static void onLoad() {
instance = new AsyncLoader44();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(44);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks44", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks44", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader44__Callback newCallback = new AsyncLoader44__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(44)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(44,
...
while (callbacksHead != null) {
  ...
  AsyncLoader44__Callback next = callbacksHead;
