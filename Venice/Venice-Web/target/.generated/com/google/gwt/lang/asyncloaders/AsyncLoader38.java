...
public class AsyncLoader38 {
// Callbacks that are pending
private static AsyncLoader38__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader38__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader38 instance = null;
public static void onLoad() {
instance = new AsyncLoader38();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(38);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks38", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks38", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader38__Callback newCallback = new AsyncLoader38__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(38)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(38,
...
while (callbacksHead != null) {
  ...
  AsyncLoader38__Callback next = callbacksHead;
