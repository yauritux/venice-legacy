...
public class AsyncLoader43 {
// Callbacks that are pending
private static AsyncLoader43__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader43__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader43 instance = null;
public static void onLoad() {
instance = new AsyncLoader43();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(43);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks43", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks43", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader43__Callback newCallback = new AsyncLoader43__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(43)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(43,
...
while (callbacksHead != null) {
  ...
  AsyncLoader43__Callback next = callbacksHead;
