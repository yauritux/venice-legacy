...
public class AsyncLoader41 {
// Callbacks that are pending
private static AsyncLoader41__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader41__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader41 instance = null;
public static void onLoad() {
instance = new AsyncLoader41();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(41);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks41", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks41", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader41__Callback newCallback = new AsyncLoader41__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(41)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(41,
...
while (callbacksHead != null) {
  ...
  AsyncLoader41__Callback next = callbacksHead;
